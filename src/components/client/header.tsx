    ...
    <header className='bg-green-900 text-white'>
        <div className='max-w-7xl mx-auto flex justify-between items-center'>
            ...
            <div className='flex justify-between w-full py-4'>
                <form className='pl-10 relative' onSubmit={handleSubmit(onSubmit)}>
                    <input {...register("keyword")} className='outline-0 text-black px-3 py-1 w-[300px] rounded' type='text' placeholder='Tìm kiếm'/>
