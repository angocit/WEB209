        ...
        <div className='max-w-7xl mx-auto flex justify-between items-center'>
            ...
            <div className='flex items-center w-full justify-between'>
                <form className='ml-10 relative'>
                    <input onChange={(e)=>setKeywords(e.target.value)} className='text-black border outline-none px-3 py-1 rounded w-[300px]' type='text' placeholder='Tìm kiếm'/>
                    ...
                    {(products)&&
                        <ul className='absolute top-10 left-0 bg-white w-full shadow-sm text-black'>
                            {products.map(item=>(
